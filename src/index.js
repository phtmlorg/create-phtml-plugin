...
async function updateArgs() {
	...
	args.npmId = args['npm-id'] || args['npm'] || args.id;
...
const formatKeywords = string => ['phtml', 'html', 'phtml-plugin']
	.concat(
		string
		.trim()
		.split(/\s*,\s*/)
